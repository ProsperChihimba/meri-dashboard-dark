                ...
                <Box w={260} h={150} bg='linear-gradient(119.15deg, #2E374B -13.54%, #292F3C 118.09%)' rounded='3xl'>
                    <Flex m={5} direction='column'>
                        <Flex w='100%' mb={5}>
                            ...
                            <Flex direction='column'>
                                <Center>
                                    <FiTrendingUp color='teal' height={15} />
                                    <Text ml={3} as='b' color='white' >3.3%</Text>
                                </Center>
                                <Text color='#B6B7BC' fontSize={12}>This month</Text>
                            </Flex>
                        </Flex>
                        <Flex w='100%'>
                            <Flex direction='column'>
                                <Text color='#B6B7BC' fontSize={12}>Total earning</Text>
                                <Text as='b' color='white' >1000K</Text>
                            </Flex>
                            <Spacer />
                            <Center>
                                <Button colorScheme='teal' size='sm'>
                    ...
                    <Flex m={5} direction='column'>
                        <Flex w='100%' mb={5}>
                            ...
                            <Flex direction='column'>
                                <Center>
                                    <FiTrendingUp color='teal' height={15} />
                                    <Text ml={3} as='b' color='white' >12.2%</Text>
                                </Center>
                                <Text color='#B6B7BC' fontSize={12}>This month</Text>
                            </Flex>
                        </Flex>
                        <Flex w='100%'>
                            <Flex direction='column'>
                                <Text color='#B6B7BC' fontSize={12}>Total users</Text>
                                <Text as='b' color='white' >1000</Text>
                            </Flex>
                            <Spacer />
                            <Center>
